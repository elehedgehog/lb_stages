  ...
  <div id="">
    ...
    <div v-show="isShow" class="bankCardModul">
      ...
      <div class="bankList">
        <ul @click="getBankName($event)">
          <li>
            <img src="../assets/img/huaxia@2x.png" />华夏银行</li>
          <li>
            <img src="../assets/img/pingan@2x.png" />平安银行</li>
          <li>
            <img src="../assets/img/gong@2x.png" />工商银行</li>
          <li>
            <img src="../assets/img/youzheng@2x.png" />邮政储蓄银行</li>
          <li>
            <img src="../assets/img/jianshe@2x.png" />建设银行</li>
          <li>
            <img src="../assets/img/pingan@2x.png" />平安银行</li>
        </ul>
      </div>
    ...
    <div class="inputList">
      <div class="inputItem" v-on:click="showCardList">
        ...
        <span v-if="params.bankName	===''" class="inputItemMesg">选择银行卡
          <img src="../assets/img/weqrtyui.png" />
        </span>
      </div>
      <div class="inputItem">
